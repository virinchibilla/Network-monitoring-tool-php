...
$query = "CREATE TABLE IF NOT EXISTS plot_SERVERS_vb (id INT AUTO_INCREMENT PRIMARY KEY,
										   IP varchar(255),
										   metrics LONGTEXT,
										   UNIQUE KEY (IP))";
...
?>
					...
					<li role="presentation" class="active"><a href="./graph.php">Compare</a></li>
				</ul>
			</div><br>
...
if(isset($_GET['duration']))
{
	...
	//SERVERS	
	$query = "SELECT * FROM plot_SERVERS_vb";
...
//DEVICES
	$query = "SELECT * FROM plot_DEVICES_vb";
	$result = mysqli_query($connection, $query) or die("Error:" . mysqli_error($connection));
	$num_rows = mysqli_num_rows($result);
